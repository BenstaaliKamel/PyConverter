...
class CustomImage:
    ...
    def reduce_image(self, size=0.5, quality=75):
        ...
        self.image = self.image.resize((new_width, new_height), Image.ANTIALIAS)#ANTIALIAS c une var de la classe image qui spécifie de ne pas réduire la qualité de l'image
